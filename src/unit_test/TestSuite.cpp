...
void on_init()
{
  std::cout << "Test Suite initialized." << std::endl;
  //OSS::log_information("This is a sample log using the library logger");
  //OSS::app_log_information("This is a sample log using the application logger");
}
