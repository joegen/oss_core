...
typedef void (*chimera_forward_upcall_t) (ChimeraState *, Key **, Message **, ChimeraHost **);
typedef void (*chimera_deliver_upcall_t) (ChimeraState *, Key *, Message *);
typedef void (*chimera_update_upcall_t) (ChimeraState *, Key *, ChimeraHost *, int);
