...
SBCMessageBehavior::SBCMessageBehavior(SBCManager* pManager) :
  SBCDefaultBehavior(pManager, OSS::SIP::B2BUA::SIPB2BHandler::TYPE_MESSAGE, "SBC MESSAGE Request Handler")
{
  setName("SBC MESSAGE Request Handler");
}

SBCMessageBehavior::~SBCMessageBehavior()
{
}

void SBCMessageBehavior::onProcessResponseOutbound(
