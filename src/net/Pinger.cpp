...
bool Pinger::ping_host(const std::string& destination, int sequence, int ttl, ping_host_handler handler, void* user_data)
{
  try {
    Pinger* pinger = new Pinger(OSS::net_io_service());
