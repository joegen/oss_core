#ifndef OSS_DynamicHashTable_H_INCLUDED
#define OSS_DynamicHashTable_H_INCLUDED
...
class OSS_API DynamicHashTable
{
public:
...
protected:
  ...
  mutable OSS::mutex_read_write _rwMutexStringToString;
  mutable OSS::mutex_read_write _rwMutexIntToString;
  mutable OSS::mutex_read_write _rwMutexStringToVectorString;
  mutable OSS::mutex_read_write _rwMutexIntToVectorString;
  mutable OSS::mutex_read_write _rwMutexStringToMapString;
  mutable OSS::mutex_read_write _rwMutexIntToMapString;
  mutable OSS::mutex_read_write _rwMutexStringToAny;
  mutable OSS::mutex_read_write _rwMutexIntToAny;
  mutable OSS::mutex_read_write _rwMutexStringToVectorAny;
  mutable OSS::mutex_read_write _rwMutexIntToVectorAny;
};

} // OSS
#endif // OSS_DynamicHashTable_H_INCLUDED
