...
#ifndef SIP_SBCNOTIFYBEHAV_INCLUDED
#define SIP_SBCNOTIFYBEHAV_INCLUDED
...
class OSS_API SBCNotifyBehavior : public SBCDefaultBehavior
{
public:
  SBCNotifyBehavior(SBCManager* pManager);
    /// Creates a new SBC register behavior
    /// This is the base class of all SBC behaviors

  virtual ~SBCNotifyBehavior();
...
private:
  SBCSubscribeBehavior* _pSubscribeBehavior;
