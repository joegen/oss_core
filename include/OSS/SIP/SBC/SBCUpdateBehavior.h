...
#ifndef SIP_SBCUPDATEBEHAV_INCLUDED
#define SIP_SBCUPDATEBEHAV_INCLUDED
...
class OSS_API SBCUpdateBehavior : public SBCDefaultBehavior
{
public:
  SBCUpdateBehavior(SBCManager* pManager);
    /// Creates a new SBC register behavior
    /// This is the base class of all SBC behaviors

  virtual ~SBCUpdateBehavior();
...
#endif // SIP_SBCUPDATEBEHAV_INCLUDED
