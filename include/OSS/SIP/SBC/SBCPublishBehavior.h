...
#ifndef SIP_SBCPUBLISHBEHAV_INCLUDED
#define SIP_SBCPUBLISHBEHAV_INCLUDED
...
class OSS_API SBCPublishBehavior : public SBCDefaultBehavior
{
public:
  SBCPublishBehavior(SBCManager* pManager);
    /// Creates a new SBC register behavior
    /// This is the base class of all SBC behaviors

  virtual ~SBCPublishBehavior();
...
#endif // SIP_SBCPUBLISHBEHAV_INCLUDED
