...
#ifndef SIP_SIPNistPool_INCLUDED
#define SIP_SIPNistPool_INCLUDED
...
class OSS_API SIPNistPool: protected SIPTransactionPool
...
protected:
  SIPNistPool(SIPFSMDispatch* dispatch);
  virtual ~SIPNistPool();
...
#endif // SIP_SIPNistPool_INCLUDED
