...
define(`repo_filename',`oss.repo')
define(`repo_contents',
[oss]
name=oss build service for CentOS 5 - \$basearch
...
#... Prevent oss from starting after first reboot as it is not yet configured
chkconfig oss off

# Postgresql will be started by oss
